...
public class CodeEditor : MonoBehaviour {
    ...
    public Scrollbar XXXX;

	void Start(){

		LoadTheme();
        //mainInput.onValueChanged.AddListener(WriteEvent);
        float preferredHeight = mainInput.textComponent.preferredHeight;
        float currentHeight = mainText.rectTransform.rect.height;
        mainInput.verticalScrollbar.gameObject.SetActive(preferredHeight >= currentHeight);
    }
	...
	void Update(){
        ...
        if (Input.anyKeyDown && mainInput.isFocused)
